...
function provision_credentials_payload(PDO $db, string $extension, string $jti): array {
	...
	return [
		...
		'host' => provision_sip_server(),
		'domain' => provision_sip_server(),
		'sip_uri' => 'sip:' . $extension . '@' . provision_sip_server(),
		'registrar_uri' => 'sip:' . provision_sip_server(),
